...
SWEP.SubCategory = "4Sniper Rifles"
SWEP.AdminOnly = false

SWEP.PrintName = "M82"
SWEP.TrueName = "M82A1M"
...
SWEP.Description = [[Semi-auto sniper rifle. Heavy recoil with slow handling and improved bullet velocity. 1-shot kill to the head, chest, or stomach. Hold L SHIFT while ADS to steady.

The Barrett .50cal (sometimes referred to as M82) is a semi-automatic sniper rifle featured in Call of Duty 4: Modern Warfare, Call of Duty: Modern Warfare 2, Call of Duty: Modern Warfare 3, Call of Duty: Modern Warfare 3: Defiance, Call of Duty: Black Ops II, Call of Duty: Modern Warfare Remastered, Call of Duty: Black Ops Cold War, and Call of Duty: Black Ops 6.

The Barrett .50cal returns in Call of Duty: Black Ops Cold War as the M82.]]
...
SWEP.PhysBulletMuzzleVelocity = 731 * 39.37
...
SWEP.DropMagazineModel = "models/weapons/arc9/atts/bocw_m82_magazine.mdl" -- Set to a string or table to drop this magazine when reloading.
...
SWEP.AimDownSightsTime = 0.666 -- How long it takes to go from hip fire to aiming down sights.
...
SWEP.ShootSound = "ARC9_BOCW.M82_fire"
--SWEP.ShootSoundIndoor = "ARC9_BOCW.M82_fire_int_decay"                  -- Fire indoors
SWEP.ShootSoundSilenced = "ARC9_BOCW.M82_fire_silenced"                    -- Fire silenced
...
SWEP.CustomizePos = Vector(22, 47, 5)
SWEP.CustomizeRotateAnchor = Vector(22, 0, -4)
...
SWEP.Attachments = {
    {
        ...
        Bone = "tag_weapon",
        Pos = Vector(5.8, 0, 4.55),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(0, 0, 0),
        Category = {"bocw_m82_optic", "bocw_optic"},
        Installed = "bocw_m82_optic_base",
        Integral = "bocw_m82_optic_base",
    },
    {
        PrintName = "MUZZLE",
        Bone = "tag_muzzle",
    ...
    },
    {
        ...
        Category = {"bocw_m82_barrel"},
        InstalledElements = {"barrelgone"},
    },
    {
        PrintName = "BODY",
        Bone = "tag_barrel",
        Pos = Vector(3.3, 1, 0.4),
        Ang = Angle(0, 0, -25),
        Icon_Offset = Vector(0, 0, 0),
    ...
    },
    {
        ...
        Pos = Vector(0, 0, 0),
        Ang = Angle(0, 0, 0),
        Icon_Offset = Vector(-1, 0, -1.75),
        Category = {"bocw_m82_wrap"},
    },
    {
        PrintName = "STOCK",
        Bone = "tag_weapon",
    ...
    },
    {
        PrintName = "STICKER 1",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_m82_sticker1.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 2",
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_m82_sticker2.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 3", 
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_m82_sticker3.mdl",
        CosmeticOnly = true,
    },
    {
        PrintName = "STICKER 4", 
        Category = "stickers",
        StickerModel = "models/weapons/arc9/stickers/bocw_m82_sticker4.mdl",
        CosmeticOnly = true,
    },
}
--=========================================================
...
local CustomSlotTable = {
    ...
    Pos = Vector(0, 0, 0),
    Ang = Angle(0, 0, 0),
    Icon_Offset = Vector(-12, 0, 2.5),
    Category = {"bocw_custom_slot", "bocw_custom_slot_m82"},
}
...
SWEP.Hook_ModifyBodygroups = function(self, data)
    ...
    if attached["bocw_sniper_optic_ironsights"] then
        vm:SetBodygroup(2, 0)
    end
...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if elements["m82_mag_ext"] then
        return anim .. "_ext"
    end

    if elements["m82_mag_fast"] then
        return anim .. "_fast"
    end

    if elements["m82_mag_mix"] then
        return anim .. "_mix"
    end
end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = {"ready"},
        EventTable = {
            { s = "ARC9_BOCW.M82_reload_shoulder", t = 0.3 },
            { s = "ARC9_BOCW.M82_ready_boltback", t = 0.7 },
            { s = "ARC9_BOCW.M82_ready_boltrelease", t = 1.1 },
            { s = "ARC9_BOCW.M82_reload_shoulderdown", t = 1.3 },
            { s = "ARC9_BOCW.M82_reload_end", t = 1.6 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.M82_reload_magoutstart", t = 1 },
            { s = "ARC9_BOCW.M82_reload_magout", t = 1.3 },
            { s = "ARC9_BOCW.M82_reload_maginstart", t = 2.1 },
            { s = "ARC9_BOCW.M82_reload_magin", t = 2.2 },
            { s = "ARC9_BOCW.M82_reload_shoulderdown", t = 2.7 },
            { s = "ARC9_BOCW.M82_reload_end", t = 3 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.M82_reload_shoulder", t = 0.5 },
            { s = "ARC9_BOCW.M82_reload_magoutstart", t = 1 },
            { s = "ARC9_BOCW.M82_reload_magout", t = 1.4 },
            { s = "ARC9_BOCW.M82_reload_maginstart", t = 2.1 },
            { s = "ARC9_BOCW.M82_reload_magin", t = 2.2 },
            { s = "ARC9_BOCW.M82_reload_shoulderdown", t = 2.7 },
            { s = "ARC9_BOCW.M82_reload_boltback", t = 3.5 },
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.M82_reload_magout", t = 1 },
            { s = "ARC9_BOCW.M82_reload_maginstart", t = 1.9 },
            { s = "ARC9_BOCW.M82_reload_magin", t = 2 },
            { s = "ARC9_BOCW.M82_reload_end", t = 2.6 },
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty_fast"] = {
        ...
        EventTable = {
            ...
            { s = "ARC9_BOCW.M82_reload_maginstart", t = 1.9 },
            { s = "ARC9_BOCW.M82_reload_magin", t = 2 },
            { s = "ARC9_BOCW.M82_reload_boltback", t = 3.2 },
    ...
    ["enter_inspect"] = {
        Source = "inspect",
        EventTable = {
            { s = "ARC9_BOCW.M82_inspect_part1", t = 0 },
            { s = "ARC9_BOCW.M82_inspect_part2", t = 2.4 },
            { s = "ARC9_BOCW.M82_inspect_part3", t = 6.9 },
        },
        IKTimeLine = {
            {
                t = 0,
